...
public class C01_Priority {
    ...
    WebDriver driver;
    //priority yazmadigimiz methodlari =0 olarak kabul eder
    //priority olmayanlari kendi icinde siralayip olanlarin priority
    //degerlerine uygun siralamada calisir
    @BeforeMethod
    public void setup(){
