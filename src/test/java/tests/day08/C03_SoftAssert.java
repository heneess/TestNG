...
public class C03_SoftAssert {
    ...
    public void test(){
        ...
        //option listesi webelementlerden olusur
        //expected liste ise Stirng , bunun icin opsiyon listesini string yapmaliyiz
        ...
        List<String> expectedOptionsList=Arrays.asList("Select One", "Australia (dollar)", "Canada (dollar)","Switzerland (franc)","China (yuan)","Denmark (krone)",
                 "Eurozone (euro)","Great Britain (pound)","Hong Kong (dollar)","Japan (yen)","Mexico (peso)","Norway (krone)",
                 "New Zealand (dollar)","Sweden (krona)","Singapore (dollar)","Thailand (baht)");
